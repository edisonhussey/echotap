...
//         // Normalize vector and scale to fixed length 0.2
...
//         // Bounce logic for x
//         if (nextX < 0.1f) {
//             nextX = 0.1f + (0.1f - nextX); // reflect back inside
//             rotatedX = -rotatedX;          // reverse direction
//         }
//         else if (nextX > 0.9f) {
...
//         // Update previous positions: old current pos becomes previous,
//         // new pos becomes current, so next call continues correctly
//         previous_positions[0] = previous_positions[2];
//         previous_positions[1] = previous_positions[3];
