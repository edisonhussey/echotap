...
//             prompt prompt;
//             prompt.start_window = beat_time - some_margin;
//             prompt.end_window = beat_time + some_margin;
//             prompt.prompt_text = question.prompt;
//             prompt.x = 0.5f; // example
//             prompt.y = 0.2f; // example
//             prompts.push_back(prompt);
            
//             // Add taps for each choice
//             for (size_t c = 0; c < question.choices.size(); ++c) {
//                 tap tap;
//                 tap.perfect_hit_time = beat_time;
//                 tap.x = 0.2f + 0.15f * c; // spread horizontally
//                 tap.y = 0.5f;
//                 tap.is_correct = (c == 0);
//                 tap.start_window = beat_time - 0.5f;
//                 tap.end_window = beat_time + 0.5f;
//                 // other tap fields...
//                 taps.push_back(tap);
//             }
//         } else {
...
//             tap tap;
//             tap.perfect_hit_time = beat_time;
//             tap.x = 0.5f; // example center
//             tap.y = 0.5f;
//             tap.is_correct = false;
//             tap.start_window = beat_time - 0.3f;
//             tap.end_window = beat_time + 0.3f;
//             taps.push_back(tap);
//         }
//     }
