...
// bool Renderer::initBackgroundShaders() {
//     // Load, compile, and link backgroundShaderProgram (you may already have shader loader function)
//     backgroundShaderProgram = LoadShader("shaders/background.vert", "shaders/background.frag"); // Use your loader here
//     return backgroundShaderProgram != 0;
// }

// void Renderer::setupBackgroundBuffers() {
//     float vertices[] = {
...
// // Vertex shader source for background (full screen quad)
// const char* backgroundVertexShaderSrc = R"(
// #version 330 core
// layout(location = 0) in vec2 aPos;
...
// const char* backgroundFragmentShaderSrc = R"(
// #version 330 core
// out vec4 FragColor;
...
//     // Compile vertex shader
//     GLuint vertexShader = glCreateShader(GL_VERTEX_SHADER);
//     glShaderSource(vertexShader, 1, &backgroundVertexShaderSrc, NULL);
//     glCompileShader(vertexShader);
//     // Check compile errors...

//     // Compile fragment shader
//     GLuint fragmentShader = glCreateShader(GL_FRAGMENT_SHADER);
//     glShaderSource(fragmentShader, 1, &backgroundFragmentShaderSrc, NULL);
//     glCompileShader(fragmentShader);
//     // Check compile errors...
...
//     return true; // add error checks in real code
// }
...
// void Renderer::render_background(float r, float g, float b, float a = 1.0f) {
//     glUseProgram(backgroundShaderProgram);
//     glBindVertexArray(backgroundVAO);

//     GLint colorLoc = glGetUniformLocation(backgroundShaderProgram, "uColor");
